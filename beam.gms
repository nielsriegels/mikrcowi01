...
execute "gdxxrw.exe I=%path%output\BEAM-flows.gdx O=%path%output\BEAM-flows.xls par=rFlow rng=rFlow!B10 par=rsFlow rdim=4 rng=rsFlow!B10 rdim=4 par=rcFlow rdim=4 rng=rcFlow!B10 rdim=4";
execute "pause";
